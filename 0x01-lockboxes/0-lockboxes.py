...
def canUnlockAll(boxes):
    ...
    Start with the key to box 0, then collect keys from accessible boxes.
    Continue unlocking boxes with the collected keys until no more boxes can be unlocked.
